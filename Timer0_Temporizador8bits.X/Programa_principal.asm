...
ENDC
  ...
  ;*********16 BITS**********  
  ;100MS 
  ; TMR0L = 65535 - (FOSC * TIEMPO)/(4* PRESCALER)
  ; TMR0L = 65535 - ((4*10^6*16S)/(4*256) 
  ; TMR0L = 176.87 = 177 -> HEX
;TIEMPO 1SEGUNDO
; 16 PRESCLAER
; 3035
; TMR0L  DB
